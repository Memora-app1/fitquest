    ...
    >
      {!unlocked && (
        <div
          ...
          style={{ background: 'rgba(5,9,20,0.4)' }}
        >
          <div className="h-5 w-5 rounded-full" style={{ background: 'rgba(255,255,255,0.1)' }} />
        </div>
      )}
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 p-4 md:p-8">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(245,200,66,0.09) 0%, rgba(13,24,41,0.98) 60%, rgba(124,58,237,0.06) 100%)',
          ...
          <div className="flex shrink-0 flex-col items-center gap-2">
            ...
            >
              <div className="space-y-1 text-center">
                <div className="shimmer mx-auto h-8 w-12 rounded-xl" />
                <div className="shimmer mx-auto h-2.5 w-16 rounded-full" />
              </div>
            </div>
              ...
              >
                <div
                  ...
                  style={{
                    width: '65%',
                    background:
                      'linear-gradient(90deg, rgba(245,200,66,0.4), rgba(245,200,66,0.2))',
                  }}
                />
              </div>
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-2">
          {[{ accent: '245,200,66' }, { accent: '255,77,0' }, { accent: '0,255,136' }].map(
            ({ accent }, i) => (
              <div
                key={i}
              ...
              >
                <div className="shimmer mx-auto mb-1.5 h-4 w-14 rounded-lg" />
                <div className="shimmer mx-auto h-2.5 w-16 rounded-full" />
              </div>
            )
          )}
        ...
        {/* Bar chart */}
        <div className="flex h-28 items-end gap-3 px-1">
          {[40, 60, 30, 85, 50, 70, 55].map((h, i) => (
            <div key={i} className="flex flex-1 flex-col items-center gap-2">
              ...
              />
              <div className="shimmer h-2 rounded-full" style={{ width: i === 6 ? 28 : 20 }} />
            </div>
          ))}
        </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        {['#FF4D00', '#7C3AED', '#FF4D00'].map((accent, i) => (
          ...
          >
            <div
              className="mx-auto mb-2 h-9 w-9 rounded-xl"
              style={{ background: `${accent}15` }}
            />
            <div className="shimmer mx-auto mb-1 h-7 w-12 rounded-xl" />
            <div className="shimmer mx-auto h-2.5 w-14 rounded-full" />
          </div>
        ))}
      </div>
