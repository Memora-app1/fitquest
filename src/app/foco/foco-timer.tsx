...
import { Zap, Play, Pause, RotateCcw, TreePine, CheckCircle2 } from 'lucide-react';
        ...
        >
          ...
          {sessionsToday > 0 && (
            ...
            >
              ...
              {sessionsToday} sessão{sessionsToday !== 1 ? 'ões' : ''} concluída
              {sessionsToday !== 1 ? 's' : ''} hoje
            </div>
          )}
        </div>
              ...
              {phase === 'done' ? (
                ...
                <>
                  ...
                  <div
                    ...
                    style={{
                      color:
                        phase === 'running' ? '#00FF88' : phase === 'paused' ? '#F5C842' : '#FFFFFF',
                    }}
                  >
                    {timeDisplay}
                  </div>
