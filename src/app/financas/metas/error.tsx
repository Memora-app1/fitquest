    ...
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      ...
      >
        ...
        <div className="relative z-10 space-y-6">
          ...
          >
            ...
            <div>
              <p className="text-sm text-text-secondary">
                Não foi possível carregar suas metas financeiras. Seus objetivos e progresso de
                economia estão seguros no servidor.
              </p>
              {error.digest && (
          ...
          >
            <ShieldCheck size={14} className="shrink-0 text-brand-gold" />
