...
import { RefreshCw, Home, PiggyBank, AlertCircle, ShieldCheck } from 'lucide-react'

export default function MetasFinanceirasError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[MetasFinanceirasError]', error)
  }, [error])
      ...
      >
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex items-center gap-4">
            ...
            >
              <PiggyBank size={26} style={{ color: '#00FF88' }} />
            </div>
            <div>
              <div
              ...
              <h1 className="text-xl font-black">Erro ao carregar metas financeiras</h1>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <p className="text-sm text-text-secondary">
                Não foi possível carregar suas metas financeiras. Seus objetivos e progresso
                de economia estão seguros no servidor.
              </p>
              {error.digest && (
          ...
          >
            ...
            <p className="text-xs text-text-secondary">
              Todas as metas e aportes registrados continuam protegidos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            ...
            <Link
              ...
              style={{ background: 'rgba(0,255,136,0.08)', color: '#00FF88', border: '1px solid rgba(0,255,136,0.16)' }}
            >
              Resumo
            </Link>
            <Link
