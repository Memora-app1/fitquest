...
export const metadata: Metadata = {
  title: 'Finanças',
  description:
    'Controle gastos, receitas e metas financeiras. Saiba exatamente onde seu dinheiro vai.',
};
...
export default async function FinancasPage() {
  ...
  const [accountsRes, monthTxRes, recentTxRes, upcomingTxRes, catTxRes, catsRes, prevMonthTxRes] =
    await Promise.all([
      supabase
  ...
  for (const tx of catTxRes.data ?? []) {
    ...
    spendByCategory.set(
      tx.category_id,
      (spendByCategory.get(tx.category_id) ?? 0) + Number(tx.amount)
    );
  }
    ...
    <AppShell>
      <div className="mx-auto max-w-6xl space-y-6 p-4 md:p-8">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(0,255,136,0.08) 0%, rgba(13,24,41,0.98) 60%, rgba(124,58,237,0.06) 100%)',
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div
              className={`heading-display mb-3 text-5xl md:text-6xl ${totalBalance < 0 ? 'text-brand-red' : 'text-brand-gold'}`}
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs text-text-muted">
                  <span className="font-medium text-brand-green">
                    ↑ {formatBRL(income)} receitas
                  </span>
                  <span className="font-medium text-brand-red">↓ {formatBRL(expense)} gastos</span>
                </div>
                <div
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      width: `${expenseRatio}%`,
                      background: 'linear-gradient(90deg, #FF4D00, #CC3A00)',
                    }}
                  />
                </div>
                <div className="flex items-center justify-between text-xs text-text-muted">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-2 text-xs text-text-muted">
                {income > 0
                  ? `${income > expense ? '✅ Acima dos gastos' : '⚠️ Abaixo dos gastos'}`
          ...
          >
            ...
            />
            <div className="relative z-10">
              <div className="mb-2 flex items-center gap-2 text-sm font-semibold text-brand-orange">
                <TrendingDown size={16} />
                <span className="text-xs uppercase tracking-wider">Gastos em {monthNameShort}</span>
              </div>
              ...
              {expenseDiff !== null && expenseDiffPct !== null ? (
                <div
                  className={`mt-2 text-xs ${expenseDiff <= 0 ? 'text-brand-green' : 'text-brand-red'}`}
                >
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          >
            ...
            <div
              className={`heading-display text-2xl ${net >= 0 ? 'text-brand-green' : 'text-brand-red'}`}
            >
              {net >= 0 ? '+' : ''}
              {formatBRL(net)}
            </div>
          ...
          >
            ...
            <div className="mb-2 flex items-center gap-1">
              ...
              <span className="text-xs uppercase tracking-wider text-text-muted">Poupança</span>
            </div>
            <div
          ...
          >
            ...
            <div className="mt-1 text-xs text-text-muted">
              {daysInMonth - dayOfMonth}d restantes
            </div>
          </div>
        </div>
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                ...
                <p className="mt-0.5 text-xs text-text-muted">
                  Este mês · top {categorySpend.length} categorias
                </p>
              </div>
              <span className="rounded-full bg-bg-elevated px-3 py-1.5 text-xs text-text-muted">
            ...
            <div className="mt-5 space-y-3">
              {categorySpend.map((cat) => (
                <div key={cat.name} className="flex items-center gap-3">
                  <span className="w-7 shrink-0 text-center text-lg">{cat.icon}</span>
        ...
        <section>
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link
              ...
              className="flex items-center gap-1 text-sm text-text-secondary transition-colors hover:text-brand-orange"
            >
          ...
          {accounts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
              ...
              {accounts.length > 3 && (
                <Link
                  href="/financas/contas"
                  className="flex items-center justify-center gap-2 rounded-2xl p-5 text-text-muted transition-all hover:text-brand-orange"
                  style={{
                ...
                >
                  <Plus size={16} />
                  <span>
                    {accounts.length - 3} conta{accounts.length - 3 !== 1 ? 's' : ''} a mais
                  </span>
                </Link>
              )}
            </div>
        ...
        {upcomingTxRes.data && upcomingTxRes.data.length > 0 && (
          <section>
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="ml-auto rounded-full bg-brand-red/15 px-2 py-1 text-xs font-semibold text-brand-red">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div
                          className={`mt-0.5 text-xs ${isUrgent ? 'text-brand-red' : 'text-text-muted'}`}
                        >
                          {daysUntil === 0
                            ? '⚠️ Vence hoje'
                            : daysUntil === 1
                    ...
                    <div className="shrink-0 font-bold text-brand-red">
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background:
                          tx.type === 'income' ? 'rgba(0,255,136,0.12)' : 'rgba(255,77,0,0.12)',
                      }}
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-0.5 flex items-center gap-2 text-xs text-text-muted">
                        ...
                        {!tx.is_paid && (
                          <>
                            <span>·</span>
                            <span className="font-medium text-brand-red">Pendente</span>
                          </>
                        )}
                      </div>
                    </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <Link
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(245,200,66,0.08) 0%, rgba(13,24,41,0.95) 100%)',
              border: '1px solid rgba(245,200,66,0.2)',
            }}
          >
            <Building2 size={22} className="mx-auto mb-2 text-brand-gold" />
            <div className="text-sm font-semibold">Contas</div>
          </Link>
          <Link
            href="/financas/metas"
            className="rounded-xl p-4 text-center transition-all hover:scale-[1.02]"
            style={{
              background:
                'linear-gradient(135deg, rgba(0,255,136,0.08) 0%, rgba(13,24,41,0.95) 100%)',
              border: '1px solid rgba(0,255,136,0.2)',
            }}
          >
            <Target size={22} className="mx-auto mb-2 text-brand-green" />
          ...
          <Link
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(124,58,237,0.08) 0%, rgba(13,24,41,0.95) 100%)',
              border: '1px solid rgba(124,58,237,0.2)',
            }}
          >
            <BarChart3 size={22} className="mx-auto mb-2 text-brand-purple" />
