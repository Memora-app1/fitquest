  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(0,255,136,0.07) 0%, rgba(13,24,41,0.99) 60%, rgba(245,200,66,0.04) 100%)',
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex items-center gap-4">
            <div
              ...
              style={{ background: 'rgba(0,255,136,0.1)', border: '1px solid rgba(0,255,136,0.24)' }}
            >
          ...
          >
            ...
            <div>
              <p className="text-sm text-text-secondary">
                Não foi possível carregar os detalhes deste treino. Os dados de séries, exercícios
                e PRs estão seguros no servidor.
              </p>
              {error.digest && (
