...
export function CronTriggerButton({ path }: Props) {
  ...
  if (status === 'loading') {
    return (
      <div
        className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold opacity-60"
  ...
  return (
    <button
      onClick={trigger}
      className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold transition-all hover:opacity-80 active:scale-95"
      style={{
