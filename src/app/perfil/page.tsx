  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-3xl space-y-6 p-4 md:p-8">
        ...
        >
          ...
          <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-text-secondary">{profile.name}</p>
            </div>
        ...
        <XpLevelJourney userId={user.id} xpTotal={profile.xp_total} currentLevel={profile.level} />
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="mb-2 flex items-center gap-1.5">
                    {stat.icon}
                    <span className="text-xs uppercase leading-tight tracking-wider text-text-muted">
                      {stat.label}
                    </span>
                  </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="mb-1.5 text-xs uppercase tracking-wider text-text-muted">Status</div>
              <div
                className="flex w-fit items-center gap-1.5 rounded-xl px-3 py-2 text-sm font-bold"
                style={{
            ...
            {profile.subscription_plan && (
              <div>
                <div className="mb-1.5 text-xs uppercase tracking-wider text-text-muted">Plano</div>
            ...
            {profile.trial_end && profile.subscription_status === 'trial' && (
              <div>
                ...
                <div className="text-sm font-bold text-brand-gold">
                  {formatDateBR(profile.trial_end)}
                </div>
              </div>
            )}
        ...
        >
          <h2 className="mb-3 text-lg font-bold text-brand-red">Zona de perigo</h2>
          <form action="/api/auth/logout" method="POST">
            <button
              type="submit"
              className="btn-ghost w-full border-brand-red/40 text-brand-red hover:bg-brand-red/10"
            >
              Sair da conta
            </button>
          </form>
