    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '48px' }}>
          ...
          <span style={{ color: '#8899BB', fontSize: '18px', fontWeight: 600, letterSpacing: '0.1em' }}>
            ASCENDIA
          </span>
        </div>
            ...
            <div style={{ display: 'flex', gap: '20px' }}>
              ...
              {streak > 0 && (
                ...
                >
                  ...
                  <span style={{ color: '#8899BB', fontSize: '13px', marginTop: '4px' }}>dias de streak</span>
                </div>
              )}
              ...
              {achievements > 0 && (
                ...
                >
                  ...
                  <span style={{ color: '#8899BB', fontSize: '13px', marginTop: '4px' }}>conquistas</span>
                </div>
              )}
            </div>
          </div>
