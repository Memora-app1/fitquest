...
export async function FinanceMonthCalendar({ userId }: { userId: string }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(135deg, rgba(245,200,66,0.05) 0%, rgba(13,24,41,0.98) 60%, rgba(0,255,136,0.03) 100%)',
      ...
      <div className="relative z-10 space-y-5">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-sm text-text-muted">
              {activeDays} dia{activeDays !== 1 ? 's' : ''} com movimentações · {rows.length}{' '}
              transações
            </p>
          </div>
          ...
          <div className="text-right">
            ...
            <div className="text-[10px] uppercase tracking-wider text-text-muted">saldo do mês</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2">
          {[
            ...
            {
              label: 'Dias + receita',
              value: String(incomedays),
              color: '#00FF88',
              rgb: '0,255,136',
            },
            {
              label: 'Dias + gasto',
              value: String(expenseDays),
              color: '#EF4444',
              rgb: '239,68,68',
            },
          ].map((s) => (
        ...
        <div className="flex flex-wrap items-center gap-4 text-[9px] text-text-muted">
          <div className="flex items-center gap-1.5">
            <div
              ...
              style={{ background: 'rgba(0,255,136,0.6)', border: '1px solid rgba(0,255,136,0.3)' }}
            />
          ...
          <div className="flex items-center gap-1.5">
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 4px rgba(245,200,66,0.3)',
              }}
            />
            <span>Hoje</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {worstDay && worstDay.net < 0 && (
            ...
            >
              ...
              <div className="text-sm font-black" style={{ color: '#EF4444' }}>
                {new Date(worstDay.date + 'T12:00:00').toLocaleDateString('pt-BR', {
                  day: '2-digit',
                  month: 'short',
                })}
              </div>
              <div className="mt-0.5 text-[10px] text-text-muted">
                {formatBRL(worstDay.expense)} saídas
              </div>
            </div>
          )}
          {bestDay && bestDay.net > 0 && (
            ...
            >
              ...
              <div className="text-sm font-black" style={{ color: '#00FF88' }}>
              ...
              <div className="mt-0.5 text-[10px] text-text-muted">
                {formatBRL(bestDay.income)} entradas
              </div>
            </div>
          )}
        </div>
