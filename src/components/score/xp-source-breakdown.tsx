  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div>
          <div className="mb-1.5 text-[10px] text-text-muted">Atividade diária (30d)</div>
        ...
        >
          <span className="shrink-0 text-base">{topSource.meta.emoji}</span>
          <p className="text-[11px] leading-snug text-text-secondary">
            Sua maior fonte de XP é{' '}
            <strong style={{ color: topSource.meta.color }}>{topSource.meta.label}</strong> com{' '}
            {topSource.pct90}% do total.{' '}
            {topSource.pct90 > 70
