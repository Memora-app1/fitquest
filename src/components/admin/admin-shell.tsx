...
export function AdminShell({ children, adminEmail, adminRole }: AdminShellProps) {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: '#050914' }}>
      ...
      >
        {/* Logo */}
        <div className="border-b px-4 py-5" style={{ borderColor: 'rgba(124,58,237,0.15)' }}>
        ...
        {/* Admin info */}
        <div className="border-t px-3 py-4" style={{ borderColor: 'rgba(124,58,237,0.15)' }}>
          <div className="rounded-lg px-3 py-2.5" style={{ background: 'rgba(255,255,255,0.03)' }}>
            ...
            <p className="truncate text-[11px]" style={{ color: '#8899BB' }}>
              {adminEmail}
            </p>
          </div>
          <Link
            href="/dashboard"
            className="mt-2 flex items-center gap-2 rounded-lg px-3 py-2 text-xs transition-all hover:bg-white/5"
            style={{ color: '#8899BB' }}
          >
            <LogOut size={13} />
            Voltar ao App
