...
export async function GuildWidget({ userId }: Props) {
  ...
  if (!membership) {
    return (
      <Link href="/guilds">
        <div
          className="rounded-2xl p-5 relative overflow-hidden hover:scale-[1.01] transition-transform cursor-pointer"
          style={{
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-bold text-white text-sm">Sem guild ainda</p>
    ...
    <Link href={`/guilds/${guildId}`}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-sm font-bold text-white truncate">{guild.name as string}</span>
              </div>
          ...
          {/* Minha contribuição */}
          <div
            className="rounded-xl p-2.5 flex items-center justify-between mb-3"
          ...
          {topMembers && topMembers.length > 0 && (
            <div className="space-y-1.5">
              <p className="text-[9px] font-bold uppercase tracking-widest text-text-muted flex items-center gap-1">
