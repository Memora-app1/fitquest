...
export async function HealthSummaryWidget({ userId }: { userId: string }) {
  ...
  return (
    <Link
      href="/saude"
      className="group flex items-center justify-between gap-4 rounded-2xl p-4 transition-all hover:scale-[1.01]"
      style={{
        background:
          'linear-gradient(135deg, rgba(0,217,255,0.06) 0%, rgba(13,24,41,0.98) 60%, rgba(124,58,237,0.05) 100%)',
        border:
          waterGoalDone && sleepLogged
      ...
      <div className="flex min-w-0 flex-1 items-center gap-4">
        ...
        <div className="flex shrink-0 flex-col items-center gap-1">
          ...
          <span
            ...
            style={{ color: waterGoalDone ? '#00FF88' : '#00D9FF' }}
          >
        ...
        <div className="flex shrink-0 flex-col items-center gap-1">
          ...
          <span
            className="text-[10px] font-bold"
            style={{ color: sleepLogged ? sleepColor(sleepHours) : '#8899BB' }}
          >
