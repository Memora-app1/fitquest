    ...
    >
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          {message && (
            <p
              ...
              style={{
                color: message.includes('XP') || message.includes('🌟') ? '#00FF88' : '#FF4D00',
              }}
            >
              {message}
            </p>
        ...
        <button
          ...
          className="shrink-0 rounded-lg px-3 py-1.5 text-[10px] font-black transition-all"
          style={{
            background: disabled
            ...
            color: disabled ? '#556677' : isActive ? '#00FF88' : '#7C3AED',
            border: disabled
