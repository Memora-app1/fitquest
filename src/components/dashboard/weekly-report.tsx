...
export async function WeeklyReport({ userId }: { userId: string }) {
  ...
  const habitCompletionRate = totalHabits > 0 ? Math.round((uniqueHabitDays / 7) * 100) : 0;
  ...
  const ratingConfig = {
    excellent: {
      ...
      color: '#F5C842',
      rgb: '245,200,66',
      msg: 'Você arrasei em tudo. Continue essa energia!',
    },
    good: {
      label: 'Boa Semana!',
      emoji: '⚡',
      color: '#00FF88',
      rgb: '0,255,136',
      msg: 'Progresso sólido. Uma semana bem executada.',
    },
    average: {
      label: 'Semana Regular',
      emoji: '📈',
      color: '#00D9FF',
      rgb: '0,217,255',
      msg: 'Há espaço para crescer. Essa semana pode ser melhor.',
    },
    low: {
      label: 'Pode Mais!',
      emoji: '💡',
      color: '#FF4D00',
      rgb: '255,77,0',
      msg: 'Toda jornada tem tropeços. A virada começa hoje.',
    },
  };
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mb-5 flex items-start justify-between gap-4">
            ...
            <div className="mb-1 flex items-center gap-2">
              <div
                ...
                style={{
                  ...
                  border: `1px solid rgba(${rc.rgb},0.3)`,
                }}
              >
          ...
          {/* Rating emoji */}
          <div
            className="flex h-14 w-14 shrink-0 animate-bounce-in items-center justify-center rounded-2xl text-3xl"
            style={{
          ...
          {stats.map((stat) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-0.5 text-[9px] text-text-muted">{stat.sub}</div>
              </div>
            );
          })}
        </div>
